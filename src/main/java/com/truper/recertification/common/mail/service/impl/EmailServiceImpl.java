...
public class EmailServiceImpl implements EmailService{
	 ...
	 */
	@Async
	private void sendMail(String strAsunto, String strContenido, boolean isMultipart, boolean isHTML){
		...
		MimeMessagePreparator mimeMessagePreparator = mimeMessage -> {
			...
			mimeMessageHelper.setTo(emailVo.getLstDestinatario().toArray(new String[0]));
